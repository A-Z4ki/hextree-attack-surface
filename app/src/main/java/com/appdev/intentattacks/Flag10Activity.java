...
public class Flag10Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button launchButton = findViewById(R.id.btnLaunchFlag10);
        launchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent3.setComponent(new ComponentName("io.hextree.attacksurface", "io.hextree.attacksurface.activities.Flag10Activity"));
        ...
        // Make sure to Uncomment Flag10Activity from the manifest and comment Flag11Activity and Flag12Activity.
